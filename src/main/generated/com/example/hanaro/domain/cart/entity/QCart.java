...
public class QCart extends EntityPathBase<Cart> {
    ...
    private static final long serialVersionUID = -1227244717L;
    ...
    public final com.example.hanaro.domain.user.entity.QUser user;
    ...
    public QCart(Class<? extends Cart> type, PathMetadata metadata, PathInits inits) {
        ...
        this.user = inits.isInitialized("user") ? new com.example.hanaro.domain.user.entity.QUser(forProperty("user")) : null;
    }
