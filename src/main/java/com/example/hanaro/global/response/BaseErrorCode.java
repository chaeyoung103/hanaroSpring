...
public enum BaseErrorCode implements ErrorCode {
	...
	IMAGE_NOT_PRESENT(HttpStatus.BAD_REQUEST.value(), "B003", "이미지가 존재하지 않습니다."),
	ACCESS_DENIED(HttpStatus.FORBIDDEN.value(), "B004", "접근 권한이 없습니다."),
	INVALID_TOKEN(HttpStatus.UNAUTHORIZED.value(), "B005", "유효하지 않은 토큰입니다."),
	INTERNAL_SERVER_ERROR(HttpStatus.INTERNAL_SERVER_ERROR.value(), "B999", "서버 내부 오류가 발생했습니다.");
